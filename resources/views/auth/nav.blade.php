...
<div id="mySidenav" class="sidenav">
  ...
  <a href="javascript:void(0)" class="closebtn mb-5" onclick="closeNav()" style="margin-top:-50px;">&times;</a>
    <ul>
        <li class="home_dash"><a href="{{ route('dashboard')}}"><i class="fa fa-home mr-4"></i>Dashboard</a> </li>
        <li><a href="#"><i class="fa fa-user-circle mr-4"></i>About</a> </li>
        <li><a href="{{ route('biodiesel')}}"><i class="fa fa-user-circle mr-4"></i>Add User</a> </li>
